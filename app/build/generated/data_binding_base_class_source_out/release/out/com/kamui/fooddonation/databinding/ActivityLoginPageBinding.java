...
public final class ActivityLoginPageBinding implements ViewBinding {
  ...
  private ActivityLoginPageBinding(@NonNull LinearLayout rootView, @NonNull Button button1,
  ...
  public static ActivityLoginPageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginPageBinding((LinearLayout) rootView, button1, button2, imageView);
    }
