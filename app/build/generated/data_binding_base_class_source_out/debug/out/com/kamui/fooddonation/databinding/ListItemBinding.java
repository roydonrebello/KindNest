...
public final class ListItemBinding implements ViewBinding {
  ...
  private ListItemBinding(@NonNull ConstraintLayout rootView, @NonNull CardView cardView,
      @NonNull Button claimButton, @NonNull TextView claimedBy, @NonNull TextView distance,
  ...
  public static ListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListItemBinding((ConstraintLayout) rootView, cardView, claimButton, claimedBy,
          distance, donationDestAddress, donationFoodName, donationPickupAddress, donationStatus,
          donorName, expiryDate, foodQuantity, foodType, receiverName, trackButton);
    }
