...
class RAddRequest : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val clothSize = findViewById<EditText>(R.id.clothSizeInput)
        val clothType = findViewById<EditText>(R.id.clothTypeInput)
        val bookAuthor = findViewById<EditText>(R.id.bookAuthorInput)
        val bookGenre = findViewById<EditText>(R.id.bookGenreInput)
        ...
        addDonationBtn.setOnClickListener {
            ...
            val size = clothSize.text.toString()
            val type = clothType.text.toString()
            val bookPub = bookAuthor.text.toString()
            val bookType = bookGenre.text.toString()
